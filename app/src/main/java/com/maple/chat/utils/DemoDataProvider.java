...
public class DemoDataProvider {
   ...
   /* public static List<NewsInfo> getDemoNewInfos() {
        ...
        list.add(new NewsInfo("源码", "Android源码分析--Android系统启动")
        ...
        list.add(new NewsInfo("Android UI", "XUI 一个简洁而优雅的Android原生UI框架，解放你的双手")
        ...
        list.add(new NewsInfo("面试", "写给即将面试的你")
        ...
        list.add(new NewsInfo("Android", "XUpdate 一个轻量级、高可用性的Android版本更新框架")
        ...
        list.add(new NewsInfo("Android/HTTP", "XHttp2 一个功能强悍的网络请求库，使用RxJava2 + Retrofit2 + OKHttp进行组装")
